                    ...
                    <div class="services-grid">
                        <a href="portfolio-item-1.html" class="service-card-link">
                            <div class="service-card">
                                ...
                                <div class="service-title"><p>Architectural Rendering</p></div>
                            </div>
                        </a>
                        <a href="portfolio-item-2.html" class="service-card-link">
                            <div class="service-card">
                                <div class="service-img">
                                    <img src="images/service2.jpg" alt="Concept Design">
                                </div>
                                <div class="service-title"><p>Concept Design</p></div>
                            </div>
                        </a>
                        ...
                        <a href="portfolio-item-6.html" class="service-card-link">
                            <div class="service-card">
                                <div class="service-img">
                                    <img src="images/service6.jpg" alt="Illustration">
                                </div>
                                <div class="service-title"><p>Illustration</p></div>
                            </div>
                        </a>
                    </div>
                </div>
