...
const cardWidth = 33.33; // Percentage width of each card
...
function moveCards(direction) {
    ...
    currentPosition += direction * visibleCards;
    currentPosition = Math.max(0, Math.min(currentPosition, totalCards - visibleCards));
    
    cards.style.transform = `translateX(-${currentPosition * cardWidth}%)`;
}



//paralex image start positions
